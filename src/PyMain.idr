...
compileToNode c tm = PyCg.compileToES c Node tm ["pygen"] --["node", "javascript"]
...
executeE : Ref Ctxt Defs -> (execDir : String) -> ClosedTerm -> Core ()
executeE defs dir term = do coreLift $ putStrLn "Maybe in an hour."
